...
- New R/W property for ACDropShips - `HoverHeightModifier` which is a direct pixel distance modifier on top of GroundDeliveryDistance. Only really here for CCCP compat, we recommend you stick with just GroundDeliveryDistance.
- Chambering is here!
